...
class docs_es {
   ...
   private static $SELECT="SELECT * FROM docs_es";
    //**** Constructeur ****
    ...
    public function delete($id) {
        $requete = "DELETE FROM docs_es WHERE id=" . $id ;
    ...
    public function save() {
        ...
        if ($this->_id > 0) {
            $requete = "UPDATE docs_es SET cle='" . ($this->_cle) . "'";
            $requete .= ",title='" . $this->_title . "'";
            $requete .= ",description='" . $this->_description . "'";
            $requete .= " WHERE id=" . $this->_id;

        } else {
            $requete = "INSERT INTO docs_es (";
            $requete .= "cle,";
            $requete .= "title,";
            $requete .= "description";
            $requete .= ") VALUES (";
