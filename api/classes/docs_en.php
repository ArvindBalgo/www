...
class docs_en {
   ...
   private static $SELECT="SELECT * FROM docs_en";
    //**** Constructeur ****
    ...
    public function delete($id) {
        $requete = "DELETE FROM docs_en WHERE id=" . $id ;
    ...
    public function save() {
        ...
        if ($this->_id > 0) {
            $requete = "UPDATE docs_en SET cle='" . ($this->_cle) . "'";
            $requete .= ",title='" . $this->_title . "'";
            $requete .= ",description='" . $this->_description . "'";
            $requete .= " WHERE id=" . $this->_id;

        } else {
            $requete = "INSERT INTO docs_en (";
            $requete .= "cle,";
            $requete .= "title,";
            $requete .= "description";
            $requete .= ") VALUES (";
