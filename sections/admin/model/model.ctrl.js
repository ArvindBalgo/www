angular
    ...
    .controller('modelController', function ($scope, $rootScope, $routeParams, $location, $http, Data, $timeout, FileUploader) {
        ...
        var uploader = $scope.uploader = new FileUploader({
            url: 'api/galleryUploadCustom1.php'
        });
...
// FILTERS
        ...
        vm.fnClickTabs1 = function (tabVal) {
            console.log("active tab", tabVal)
        ...
        vm.fnMaquette = function () {
            $timeout(function () {
                ...
                yourDesigner.addProduct([{
                    title: 'Recto',
                    thumbnail: 'images/gallery/recto.jpg',
                    elements: []
                }, {title: 'Verso', thumbnail: 'images/gallery/simple.png', elements: []}]);
                    ...
                    valider: {
                        ...
                        callback: function () {
                            ...
                            $http({
                                ...
                                params: {
                                    mode: 13,
                                    id_produit: vm.currentProduit.id_cata,
                                    id_category: $(".sel_transfer").select2().val()
                                },
                                url: 'api/v1/sampleControl.php'
                            }).then(function successCallback(response) {
                                vm.fnQuitter();
